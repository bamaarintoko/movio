...
export default function LoadingImage({ profile_path }: LoadingImageProps) {
    ...
    return (
        <div key={profile_path} className={`${loading ? "bg-slate-300 animate-pulse rounded-md" : "opacity-100"}`}>
            ...
            <Image
                priority
                src={`https://image.tmdb.org/t/p/w300_and_h450_smart${profile_path}`} // Replace with your dynamic poster path
                alt="Movie Poster"
                width={300}
                height={450}
